...
public class ObjectInputWindowController extends BaseController implements Initializable {
...
//
//        //View
//        validator.createCheck().dependsOn("text",view.valueProperty())
//                .withMethod((context -> {
//                    if (validateEnums(context.get("text"))) {
//                        context.error(wrongViewMSG);
//                    }
//                })).decorates(view).immediate();
//
//        //Transport
//        validator.createCheck().dependsOn("text",transport.valueProperty())
//                .withMethod((context -> {
//                    if (validateEnums(context.get("text"))) {
//                        context.error(wrongTransportMSG);
//                    }
//                })).decorates(transport).immediate();
//
//        //Furnish
//        validator.createCheck().dependsOn("text",furnish.valueProperty())
//                .withMethod((context -> {
//                    if (validateEnums(context.get("text"))) {
//                        context.error(wrongFurnishMSG);
//                    }
//                })).decorates(furnish).immediate();
    ...
    public void onSaveButtonClick(){
        ...
        try {
            ...
            ComandsWindowController.basicCommandExecution("add");
